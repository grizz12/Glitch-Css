<template>
    <div>
        <div class="container">
  <div class="glitch" data-text="RAKARMP">RAKARMP</div>
  <div class="glow">RAKARMP</div>
...
<style>
 ...
 @keyframes noise-1 {
	 ...
	 30% {
		 clip-path: inset(55px 0 34px 0);
	}
	 33.3333333333% {
		 clip-path: inset(53px 0 25px 0);
	}
	 36.6666666667% {
	 ...
	 66.6666666667% {
		 clip-path: inset(9px 0 54px 0);
	}
	 70% {
		 clip-path: inset(75px 0 14px 0);
	}
	 73.3333333333% {
		 clip-path: inset(62px 0 9px 0);
	}
	 76.6666666667% {
		 clip-path: inset(29px 0 70px 0);
	}
	 80% {
		 clip-path: inset(15px 0 81px 0);
	}
	 83.3333333333% {
		 clip-path: inset(9px 0 30px 0);
	}
	 86.6666666667% {
		 clip-path: inset(43px 0 50px 0);
	}
	 90% {
 ...
 @keyframes noise-2 {
	 ...
	 23.3333333333% {
		 clip-path: inset(46px 0 15px 0);
	}
	 26.6666666667% {
		 clip-path: inset(9px 0 60px 0);
	}
	 30% {
		 clip-path: inset(11px 0 4px 0);
	}
	 33.3333333333% {
	 ...
	 43.3333333333% {
		 clip-path: inset(26px 0 49px 0);
	}
	 46.6666666667% {
		 clip-path: inset(58px 0 13px 0);
	}
	 50% {
		 clip-path: inset(84px 0 8px 0);
	}
	 53.3333333333% {
		 clip-path: inset(38px 0 30px 0);
	}
	 56.6666666667% {
		 clip-path: inset(21px 0 55px 0);
	}
	 60% {
	 ...
	 76.6666666667% {
		 clip-path: inset(21px 0 77px 0);
	}
	 80% {
		 clip-path: inset(57px 0 21px 0);
	}
	 83.3333333333% {
		 clip-path: inset(39px 0 19px 0);
	}
	 86.6666666667% {
		 clip-path: inset(48px 0 44px 0);
	}
	 90% {
		 clip-path: inset(30px 0 62px 0);
	}
	 93.3333333333% {
		 clip-path: inset(18px 0 47px 0);
	}
	 96.6666666667% {
		 clip-path: inset(16px 0 1px 0);
	}
	 100% {
